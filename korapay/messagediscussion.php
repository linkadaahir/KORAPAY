 ...
 <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- Direct Chat -->
        <h4 class="mt-4 mb-2">Mr Mbeukou</h4>
        <div class="row">
          <div class="col-md-12">
            <!-- DIRECT CHAT PRIMARY -->
            <div class="card card-prirary cardutline direct-chat direct-chat-primary">
              <div class="card-header">
                <h3 class="card-title">Message de Discussion </h3>
                ...
                <div class="direct-chat-messages">
                   ...
                   <div class="direct-chat-msg right">
                    <div class="direct-chat-infos clearfix">
                      ...
                      <span class="direct-chat-timestamp float-left">06 avr 12:10 pm</span>
                    </div>
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="image/47909.png" alt="Message User Image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                      bonjour je vous contacte pour la maison en location
                    </div>
                    <!-- /.direct-chat-text -->
                  ...
                  <div class="direct-chat-msg">
                    <div class="direct-chat-infos clearfix">
                      <span class="direct-chat-name float-left">Mr Mbeukou</span>
                      <span class="direct-chat-timestamp float-right">06 avr 12:00 pm</span>
                    </div>
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="image/Mbeukou.jpeg" alt="Message User Image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                  salut je suis l'agent immobilier à la charge de cette maison
                    </div>
                    <!-- /.direct-chat-text -->
                  </div>
                  <!-- /.direct-chat-msg -->
                  ...
                  <div class="direct-chat-msg right">
                    <div class="direct-chat-infos clearfix">
                      <span class="direct-chat-name float-right">moi</span>
                      <span class="direct-chat-timestamp float-left">06 avr 12:01 pm</span>
                    </div>
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="image/47909.png" alt="Message User Image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg">
                    <div class="direct-chat-infos clearfix">
                      <span class="direct-chat-name float-left">Mr Mbeukou</span>
                      <span class="direct-chat-timestamp float-right">06 avr 12:03 pm</span>
                    </div>
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="image/Mbeukou.jpeg" alt="Message User Image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                      vouler vous que nous visitions la maison alors?
                    </div>
                    <!-- /.direct-chat-text -->
                  </div>
                  <!-- /.direct-chat-msg -->
