  ...
  <div class="content-wrapper" style="background-color:  #e3f2fd;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">KoraPay</h1>
          </div>
          <div class="col-sm-6">
        ...
        <section class="content" style="background-color:  #e3f2fd;">
            ...
            <div class="row">
              <div class="col-lg-4 col-6">
                ...
                <div class="small-box bg-info">
                   <div class="row">
                      <div class="col-5 h2 container" >Gestion biens</div>
                      <div class="col-4 container"><svg xmlns="http://www.w3.org/2000/svg" height="100" viewBox="0 0 24 24" width="100"><path d="M0 0h24v24H0z" fill="none"/><path fill="#e9f8fd" d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg></div>
                   </div>
                 
                  <a href="#" class="small-box-footer"> 
                    <nav class="mt-2 ion-bag ">
                      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <!--les element du muni-->
                        <li class="nav-item has-treeview">
                          <a href=./index2.html class="nav-link">
                            <i class="nav-icon h3"></i>
                            <p class="h3" style="color: whitesmoke">
                              Acceder
                            </p>
                          </a>
              ...
              <div class="col-lg-4 col-6">
                ...
                <div class="small-box bg-warning">
                  <div class="inner">
                    <div class="row">
                      <div class="col-6 h3 container" style="color: white;">Gestion payements</div>
                      <div class="col-4 container">
                        <svg xmlns="http://www.w3.org/2000/svg" height="80"  viewBox="0 0 24 24" width="80"><path d="M0 0h24v24H0z" fill="none"/><path fill="#e9f8fd" d="M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z"/></svg>
                      </div>
                   </div>
                  </div>
                  <a href="#" class="small-box-footer"> 
              ...
              <div class="col-lg-4 col-6">
                ...
                <div class="small-box bg-danger">
                   <div class="row ">
                      <div class="col-5 h3 container" >Gestion individus</div>
                      <div class="col-4 container"><svg xmlns="http://www.w3.org/2000/svg" height="100" viewBox="0 0 24 24" width="100"><path d="M0 0h24v24H0z" fill="none"/><path  fill="#e9f8fd" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg></div>
                   </div>
                  ...
                  <a href="#" class="small-box-footer"> 
                    <nav class="mt-2 ion-bag ">
                      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <!--les element du muni-->
                        <li class="nav-item has-treeview">
                          <a href="./GestionIndividus.php" class="nav-link">
                            <i class="nav-icon h3"></i>
                            <p style="color: white;" class="h4">
                              Acceder
                            </p>
