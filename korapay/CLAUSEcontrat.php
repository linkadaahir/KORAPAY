    ...
    <!-- /.sidebar -->
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Demande de Contrat</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
        ...
        <div class="content">
          <div class="container-fluid">
              ...
              <div class="container-fluid">
                ...
                <div class="card card-dark " style="background-color: white;">
                      ...
                      <form role="form" id="quickForm">
                        <div class="card-body" >
                           ...
                           <center><h3>Voulez-vous envoyer une demande de contrat à l'Agent immobilier? </h3></center> 
                            </div> <!-- phrase d'introduction du contrat-->  
                               </br> </br> </br>
                          <strong>Conditions</strong> :
                            ...
                            <!-- premier paragraphe-->
                              <p>
                                  <ol>
                                        <li>Le cas échéant ,montant et nature des tavaux d'amélioration
                                            ou de mise en 
                                            conformité avec les
                                            caractéristiques de decence effectué depuis
                                            la fin du dernier contrat de location ou depuis
                                            le dernier renouvellement. 
                                            </li>
                                          <li>
                                              Le cas échéant, majoration du loyer en cours de bail consécutive à des travaux d'amélioration
                                              entrepris par le bailleur(nature des travaux, modalité d'execution ,
                                                delai de réalisation, ainsi que montant de la majoration du loyer)
                                          </li>
                                          <li>
                                              Le cas échéant, dimunition du  loyer en cours de bail consécutiveà des travaux
                                                entrepris par le locataire(durée de diminution, départ anticipé du locataire,
                                                modalité de son dédomagement sur justification des dépense)
                        ...
                        <div class="custom-control" style="height: 50px;"> 
                    
                          <input type="radio" id="J'accepte" name="choice" value="J'accepte" style="position: absolute; left: 16%;">
                          <label for="J'accepte" style="position: absolute; left: 20%;">Toujours envoyer</label>
                      
                          <input type="radio" id="J'accepte pas" name="choice" value="J'accepte pas" style="position: absolute; left: 51%;" >
                          <label for="J'accepte pas" style="position: absolute; left: 55%;" >Ne plus envoyer</label>
                      </div>
        
                                <!-- checkbox  designant les choix que l'utilisateur doit efectué-->
                                
                        </div>
                        <!-- /.card-body -->
        
                        <footer class="card-footer">
                          <button type="submit" class="btn btn-primary" style="position: relative; left: 85%; "  >  <a href="index.php"style="color: aliceblue;" >Retour</a></button>
                          <button type="submit" class="btn btn-primary" style="position: relative; left: 86%; "  >  <a href="Contrrat_requette_en_cours.php"style="color: aliceblue;" >valider</a></button>
                        </div>
                        </footer>
                        
                      <!-- Creation d'un liens sur le bouton 'valider' qui renvoi au contrat qui vient detre etablit-->
