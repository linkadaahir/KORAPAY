        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12">
                <img src="../images/0113.jfif" class="product-image" alt="Product Image">
              </div>
              <div class="col-12 product-image-thumbs">
                <div class="product-image-thumb active"><img src="../images/e1929e98365e15751275050.mobile-gallery-large.jpg" alt="Product Image"></div>
                <div class="product-image-thumb" ><img src="../images/salle-de-bain-theme-nature-urban-jungle-combles-amenagees-e1613037742462.webp" alt="Product Image"></div>
                <div class="product-image-thumb" ><img src="../images/d591b7088b5e2700675ecb2.desktop-gallery-large.jpg" alt="Product Image"></div>
                <div class="product-image-thumb" ><img src="../images/douche-urban-jungle-carrelage-trompe-oeil-feuille-palmier.webp" alt="Product Image"></div>
              </div>
            </div>
            <div class="col-12 col-sm-6">
              <h3 class="my-3">AKWA (Rond point mtn)</h3>
              <p>c'est une jolie villa situé en bordure de la cote  qui à une jolie vue sur la mere est acc3essible facilement de partout .
                Elle est situe à coté des bureau administratifs.
              </p>

              <hr>
            

              <h4 class="mt-3">caracteristiques <small>de la villa</small></h4>
              <div class="btn-group btn-group-toggle" data-toggle="buttons">
                <label class="btn btn-default text-center">
                  ...
                  <br>
                  Salon
                  <p>   <small>careau brillant blanc de 15 cm ave double salons</small></p>
                </label>
                <label class="btn btn-default text-center">
                  <input type="radio" name="color_option" id="color_option1" autocomplete="off">
                  ...
                  <br>
                  Chambres
                  <p>   <small>panderie et douche dans la chambre parent </small></p>
                </label>
                <label class="btn btn-default text-center">
                  <input type="radio" name="color_option" id="color_option1" autocomplete="off">
                  ...
                  <br>
                  Cuisines
                  <p>   <small>careau vers avec four àviande intégré</small></p>
                </label>
                <label class="btn btn-default text-center">
                  <input type="radio" name="color_option" id="color_option1" autocomplete="off">
                  <span class="text-xl">1</span>
                  <br>
                  douche
                  <p>   <small>internes avec careau carillolé</small></p>
                </label>
                <label class="btn btn-default text-center">
                  <input type="radio" name="color_option" id="color_option1" autocomplete="off">
                  <span class="text-xl">1</span>
                  <br>
                  magasin
                <p>   <small>moderne et bien configurer</small></p>
                </label>
              </div>
              ...
              <div class="bg-gray py-2 px-3 mt-4">
                ...
                <h4 class="mt-0">
                  <small>causion de 6 mois  payage en 1 tranche</small>
                </h4>
              </div>

              <div class="mt-4">
               <a href="messagediscussion.php">
                  <div class="btn btn-default btn-lg btn-flat">
                    <i class="fas fa-comments"></i> 
                    Discuter avec l'Agent immobilier
                  </div>
                </a>
                <a href="">
          ...
          <div class="row mt-4">
            ...
            <div class="tab-content p-3" id="nav-tabContent">
              <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab">La gestion du contenant fait allusion à une organisation du système qui améliorera le confort de travail dans l’entreprise. Ainsi il s’agit de manipuler les dossiers et les opérationnels qui les traitent. Le traitement des dossiers quand il y a lieu est effectué en grande partie par les déclarants et le Staff Directionnel quelques fois, vue la densité de cette intervention, il était opportun de matérialiser une application qui permettrait aux agents de retrouver aisément les éléments constitutifs d’un dossier.  </div>
              <div class="tab-pane fade" id="product-comments" role="tabpanel" aria-labelledby="product-comments-tab"> La gestion du contenant fait allusion à une organisation du système qui améliorera le confort de travail dans l’entreprise. Ainsi il s’agit de manipuler les dossiers et les opérationnels qui les traitent. Le traitement des dossiers quand il y a lieu est effectué en grande partie par les déclarants et le Staff Directionnel quelques fois, vue la densité de cette intervention, il était opportun de matérialiser une application qui permettrait aux agents de retrouver aisément les éléments constitutifs d’un dossier. </div>
              <div class="tab-pane fade" id="product-rating" role="tabpanel" aria-labelledby="product-rating-tab">La gestion du contenant fait allusion à une organisation du système qui améliorera le confort de travail dans l’entreprise. Ainsi il s’agit de manipuler les dossiers et les opérationnels qui les traitent. Le traitement des dossiers quand il y a lieu est effectué en grande partie par les déclarants et le Staff Directionnel quelques fois, vue la densité de cette intervention, il était opportun de matérialiser une application qui permettrait aux agents de retrouver aisément les éléments constitutifs d’un dossier. </div>
            </div>
          </div>
        </div>
        <!-- /.card-body -->
