  ...
  <aside class="main-sidebar elevation-4 sidebar-light-primary"> 
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Utilisateur connecté</a>
        </div>
      </div>
         ...
         <li class="nav-item has-treeview menu-open">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./CreationBien.php" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./Contrat.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0z" fill="none"/><path fill="#ffffff" d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm6.93 6h-2.95c-.32-1.25-.78-2.45-1.38-3.56 1.84.63 3.37 1.91 4.33 3.56zM12 4.04c.83 1.2 1.48 2.53 1.91 3.96h-3.82c.43-1.43 1.08-2.76 1.91-3.96zM4.26 14C4.1 13.36 4 12.69 4 12s.1-1.36.26-2h3.38c-.08.66-.14 1.32-.14 2 0 .68.06 1.34.14 2H4.26zm.82 2h2.95c.32 1.25.78 2.45 1.38 3.56-1.84-.63-3.37-1.9-4.33-3.56zm2.95-8H5.08c.96-1.66 2.49-2.93 4.33-3.56C8.81 5.55 8.35 6.75 8.03 8zM12 19.96c-.83-1.2-1.48-2.53-1.91-3.96h3.82c-.43 1.43-1.08 2.76-1.91 3.96zM14.34 14H9.66c-.09-.66-.16-1.32-.16-2 0-.68.07-1.35.16-2h4.68c.09.65.16 1.32.16 2 0 .68-.07 1.34-.16 2zm.25 5.56c.6-1.11 1.06-2.31 1.38-3.56h2.95c-.96 1.65-2.49 2.93-4.33 3.56zM16.36 14c.08-.66.14-1.32.14-2 0-.68-.06-1.34-.14-2h3.38c.16.64.26 1.31.26 2s-.1 1.36-.26 2h-3.38z"/></svg></i>
              <p>
                Langue
                <i class="fas fa-angle-left right"></i>
              </p>
          ...
          <li class="nav-item col-md-12">
            <a href="#" class="nav-link">
              <i class="far nav-icon"><svg  xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0z" fill="none"/><path fill="#ffffff" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg> </i>
              <p class="h6">
                Compte</p>
            </a>
          </li>
 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Création d'un Bien</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body" style=" background-color:  white">
                <form role="form"  >
                    ...
                    <div class="row">
                        ...
                        <!-- select -->
                            <div class="form-group">
                                ...
                                <option>Maison habitable</option>
                                <option>Entrepot</option>
                                <option>Espace commerciale</option>
                        ...
                        <div class="col-sm-6">
                            <!-- text input -->
                            <div class="form-group">
                              <label>Montant de Mise en Baye*</label>
                              <input type="number" min="1" class="form-control" placeholder="Entrer le Montant">
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="row">
                      <div class="col-sm-6">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" class="form-control" type="number" min="1" placeholder="Entrer le nombre de Piece">
                          </div>
                        </div>
                        ...
                        <div class="col-sm-6" >
                            ...
                            <div class="form-group">
                              ...
                              <input type="number" min="1"  class="form-control" placeholder="Entrer le nombre de Niveau">
                            </div>
                        </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-9">
                      <!-- textarea -->
                      <div class="form-group"> <label>Description du Bien*</label>
                        <textarea class="form-control" rows="3" placeholder="Saisir une description "></textarea>
                      </div>
                    </div>
                    <div class="col-sm-1">
                      <!-- radio -->
                      ...
                      <div class="form-group" >
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="gik">
                          <label class="form-check-label">Oui</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="gik" checked>
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        <label >Ville*</label>
                        <input class="form-control" type="text" min="1" placeholder="Entrer la ville" />
                      </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                          <label> Commune*</label>
                          <input type="text" class="form-control" placeholder="Entrer la commune">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Entrer le Quartier">
                      </div>
                    </div>
                  </div>  
                            ...
                            <div class="card-body" style=" background-color: white"> 
                                <button type="submit" class="btn btn-danger"  style="position: relative; left: 83%;">Annuler</button>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020-2021 <a href="https://3ibusiness.com">Kora Pay Sarl</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
