  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Effectuer un Paiement</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="container-fluid">
            ...
            <div class="card-body" style=" background-color:white">
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control" id="exampleInputEmail1" placeholder="Entrer le montant">
                    </div>
                    <div class="form-group ">
                    <label for="inputState">Statut de Paiyement*</label>
                    <select id="inputState" class="form-control">
                        <option selected>Choisir le statut de paiyement</option>
                        <option>Reglement Loyer</option>
                        <option>Avance sur Loyer</option>
                        <option>Reglement de Loyer Echeant</option>
                    </select>
                    </div>
                    <div class="form-group ">
                        <label for="inputState">Mode de Transaction*</label>
                        <select id="inputState" class="form-control">
                        <option selected>Entrer le mode de transaction</option>
                ...
                <div class="row">
                    <div class="col">
                            <button type="submit" class="btn btn-danger" id="btn2">Annuler</button>
                            <button type="submit" class="btn btn-primary" id="btn3">Valider</button>
                    </div>
