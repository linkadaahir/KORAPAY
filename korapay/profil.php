              ...
              <div class="col-md-12 " style="position: height=10px;">
                ...
                <div class="card card-widget widget-user " >
                  ...
                  <div class="widget-user-header bg-primary">
                    <h3 class="widget-user-username">Mambou jorel</h3>
                    <h5 class="widget-user-desc">Web Designer</h5>
                  </div>
                  <div class="widget-user-image">
                    <img class="img-circle elevation-2" src="image/jorel.png" alt="User Avatar">
                  </div>
                ...
                <p  >
                  <ol> <li>
                          Entretien de l'habitat ou de la location par les locataires
                      </li>
                      <li>
                          Controle de la location par le bailleur une fois en trois mois
                      </li>
                      <li>
                          Après  la prise fin du coontrat, le locataire a une mage de 8 semaines pour quitter les lieux de location
                      </li>
                ...
                <div class="custom-control" style="height: 50px;"> 
                  ...
                  <label for="J'accepte" style="position: absolute; left: 20%;">J'accepte</label>
              
                  <input type="radio" id="J'accepte pas" name="choice" value="J'accepte pas" style="position: absolute; left: 51%;" >
                  <label for="J'accepte pas" style="position: absolute; left: 55%;" >J'accepte pas</label>
              </div>
